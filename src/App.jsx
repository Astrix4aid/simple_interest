  ...
  return (
    ...
    <div style={{width:'100%',minHeight:'100vh', }} className='d-flex justify-content-center align-items-center bg-dark'>
      ...
      <form className='mt-5'>
        {/* principle amount */}
        <div className='mb-3'>
        <TextField name='principle' onChange={(e)=> validateInputs(e.target)} className='w-100' id="outlined-Principle" label="Principle" variant="outlined" />
        </div>
        ...
        {/* rate of intrest */}
        <div className='mb-3'>
        <TextField name='rate' onChange={(e)=> validateInputs(e.target)} className='w-100' id="outlined-Rate" label="Rate" variant="outlined" />
        </div>
        ...
        {/* year */}
        <div className='mb-3'>
        <TextField name='year' onChange={(e)=> validateInputs(e.target)} className='w-100' id="outlined-Year" label="Year" variant="outlined" />
        </div>
